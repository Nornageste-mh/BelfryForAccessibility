...
namespace BelfryA11y
{
    ...
    internal static class UiNav
    {
        ...
        private static void Diag(string msg)
        {
            try
            {
                if (Plugin.CfgDiagLog != null && Plugin.CfgDiagLog.Value && Plugin.Log != null)
                    Plugin.Log.LogInfo("[UiNav] " + msg);
            }
            catch { }
        }
        ...
        private static bool IsExcluded(Transform t)
        {
            try
            {
                string cfg = Plugin.CfgExcludeNames != null ? Plugin.CfgExcludeNames.Value : "";
        ...
        private static bool NeedsQuitConfirm(Selectable s)
        {
            ...
            try
            {
                string cfg = Plugin.CfgQuitNames != null ? Plugin.CfgQuitNames.Value : "Exit";
                if (string.IsNullOrEmpty(cfg)) return false;
